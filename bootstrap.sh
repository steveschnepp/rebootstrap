...
add_automatic apt
patch_apt() {
	echo "patching apt to work around cmake deficiencies #833789"
	drop_privs patch -p1 <<'EOF'
--- a/debian/rules
+++ b/debian/rules
@@ -31,4 +31,4 @@
...
patch_libtasn1_6() {
	echo "fixing libtasn1-6 FTCBFS #833707"
	patch -p1 <<'EOF'
--- a/debian/control
+++ b/debian/control
@@ -3,7 +3,7 @@
...
+ help2man, libtasn1-bin <cross>
 ...
 Standards-Version: 3.9.8
 Priority: standard
--- a/debian/patches/30_ftcbfs_help2man.patch
+++ b/debian/patches/30_ftcbfs_help2man.patch
@@ -0,0 +1,51 @@
