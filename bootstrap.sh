...
# gnumach
patch_gnumach() {
	echo "patching gnumch to support stage1 profile"
	drop_privs patch -p1 <<'EOF'
diff -Nru gnumach-1.5+git20150728/debian/control gnumach-1.5+git20150728/debian/control
--- gnumach-1.5+git20150728/debian/control
+++ gnumach-1.5+git20150728/debian/control
@@ -6,12 +6,13 @@
...
+Build-Depends: debhelper (>= 7), mig (>= 1.4-2) <!stage1>, sharutils,
...
@@ -22,6 +23,7 @@
 ...
 Architecture: any-i386
+Build-Profiles: <!stage1>
 Depends: ${misc:Depends}, gnumach-image-1.5-486-dbg
 Breaks: grub-pc (<< 1.98+20100527-1)
...
@@ -30,6 +32,7 @@
 ...
 Architecture: any-i386
+Build-Profiles: <!stage1>
 Depends: ${misc:Depends}, gnumach-image-1.5-486
...
@@ -37,6 +40,7 @@
 ...
 Architecture: any-i386
+Build-Profiles: <!stage1>
 Depends: ${misc:Depends}, gnumach-image-1.5-xen-486
 Description: GNU version of the Mach microkernel
  This package depends on the latest GNU Mach kernel for use on PCs
@@ -46,6 +50,7 @@
 
 Package: gnumach-image-1.5-486
 Architecture: any-i386
+Build-Profiles: <!stage1>
...
@@ -54,6 +59,7 @@
 ...
 Package: gnumach-image-1.5-xen-486
 Architecture: any-i386
+Build-Profiles: <!stage1>
 Depends: ${misc:Depends}, gnumach-common
 Provides: gnumach-image
...
diff -Nru gnumach-1.5+git20150728/debian/control.in gnumach-1.5+git20150728/debian/control.in
--- gnumach-1.5+git20150728/debian/control.in
+++ gnumach-1.5+git20150728/debian/control.in
@@ -6,12 +6,13 @@
 Homepage: http://www.gnu.org/software/hurd/microkernel/mach/gnumach.html
 Vcs-Browser: http://anonscm.debian.org/gitweb/?p=pkg-hurd/gnumach.git
...
@@ -22,6 +23,7 @@
 ...
 Architecture: any-i386
+Build-Profiles: <!stage1>
 Depends: ${misc:Depends}, gnumach-image-@version@-486-dbg
 Breaks: grub-pc (<< 1.98+20100527-1)
 Description: Dummy transition package for gnumach-image-*-dbg
@@ -30,6 +32,7 @@
...
+Build-Profiles: <!stage1>
 ...
 Depends: ${misc:Depends}
 Replaces: gnumach (<< 2:1.3.99.dfsg.git20110227-1)
diff -Nru gnumach-1.5+git20150728/debian/rules gnumach-1.5+git20150728/debian/rules
--- gnumach-1.5+git20150728/debian/rules
+++ gnumach-1.5+git20150728/debian/rules
@@ -109,9 +114,13 @@
 		$(common_configure) \
 		--enable-platform=xen
